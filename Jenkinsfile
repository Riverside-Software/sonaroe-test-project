...
node ('EC2-EU1B') {
  ...
  if ("master" == env.BRANCH_NAME) {
    bat "Z:\\Tools\\sonar-scanner-2.8\\bin\\sonar-scanner.bat -X -Dsonar.host.url=http://sonar.riverside-software.fr -Dproject.settings=sonar-project1.properties -Dsonar.oe.dlc=Z:\\Progress\\OpenEdge-11.7"
  } else {
